...
//// グローバル変数
////*****************************************************************************
//LPDIRECTSOUNDBUFFER8	SE_Binta;						//読みたい音の分だけバッファ確保
//LPDIRECTSOUNDBUFFER8	SE_Up;							//読みたい音の分だけバッファ確保
//LPDIRECTSOUNDBUFFER8	SE_Down;						//読みたい音の分だけバッファ確保
//LPDIRECTSOUNDBUFFER8	SE_Dash;						//読みたい音の分だけバッファ確保
//LPDIRECTSOUNDBUFFER8	SE_Scream;						//読みたい音の分だけバッファ確保
//LPDIRECTSOUNDBUFFER8	SE_Jump;						//読みたい音の分だけバッファ確保
//
////=============================================================================
//// 初期化処理
////=============================================================================
...
//	if (Type == 0)
//	{
//		SE_Binta = LoadSound(SE_BINTA);
//		SE_Up = LoadSound(SE_UP);
//		SE_Down = LoadSound(SE_DOWN);
//		SE_Dash = LoadSound(SE_DASH);
//		SE_Scream = LoadSound(SE_SCREAM);
//		SE_Jump = LoadSound(SE_JUMP);
//	}
//
//	return S_OK;
//}
